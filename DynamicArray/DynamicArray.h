...
DynamicArray::DynamicArray() { initialize(); }
...
void DynamicArray::pop_front() { erase(0, 1); }
...
void DynamicArray::pop_back() { erase(m_size - 1, m_size); }
...
bool DynamicArray::empty() const { return !m_size; }
